...
GAOS: Attempting to re-assign migration for 178577 (row 22) into the pre-migration phase and add the final locations into migration phase. Was able to to first part, but not sure about the second part. Also, there is still a 3rd phase...how do I eliminate?
```{r}
...
GAOS: Reassigning some locations to pre-migration phase. I did this and it actually eliminated some locations. Why? Perhaps because there is a day different in end and start. will redo
```{r}
